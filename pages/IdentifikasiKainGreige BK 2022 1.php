		...
		<div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
                  <thead>
                  <tr>
                    <th colspan="14" valign="middle" style="text-align: center">Masuk</th>
...
$c=0;
	...
	ITXVIEWLAPMASUKGREIGE.SUBCODE02,ITXVIEWLAPMASUKGREIGE.SUBCODE03,ITXVIEWLAPMASUKGREIGE.SUBCODE04,
       ...
       ITXVIEWLAPMASUKGREIGE.SUMMARIZEDDESCRIPTION,LEBAR.VALUEQUANTITY AS LEBAR1, GRAMASI.VALUEQUANTITY AS GSM1,
...
ITXVIEWLAPMASUKGREIGE.USERPRIMARYUOMCODE,STOCKTRANSACTION.PROJECTCODE,
	   ...
	   LEBAR.VALUEQUANTITY,GRAMASI.VALUEQUANTITY,
...
?>
      ...
      <td style="text-align: center"><?php echo round($rowdb21['LEBAR1']); ?></td>
      <td style="text-align: center"><?php echo round($rowdb21['GSM1']); ?></td>
