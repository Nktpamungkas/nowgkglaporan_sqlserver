...
$cektgl=mysqli_query($con,"SELECT DATE_FORMAT(NOW(),'%Y-%m-%d') as tgl,COUNT(tgl_tutup) as ck ,DATE_FORMAT(NOW(),'%H') as jam,DATE_FORMAT(NOW(),'%H:%i') as jam1 FROM tblmasukkain_11 WHERE tgl_tutup='".$Awal."' LIMIT 1");
...
$simpanM=mysqli_query($con,"INSERT INTO `tblmasukkain_11` SET 
...
$simpanRM=mysqli_query($con,"INSERT INTO `tblmasukkain_11` SET 
...
$simpanRMBU=mysqli_query($con,"INSERT INTO `tblmasukkain_11` SET 
...
$simpanFM=mysqli_query($con,"INSERT INTO `tblmasukkain_11` SET 
...
$simpanFMN=mysqli_query($con,"INSERT INTO `tblmasukkain_11` SET 
...
$simpanK=mysqli_query($con,"INSERT INTO `tblkeluarkain_11` SET 
...
$rowdb25P = db2_fetch_assoc($stmt5P);		
	...
	$simpanP=mysqli_query($con,"INSERT INTO `tblkeluarkain_11` SET 
...
tgl_buat =now()") or die("GAGAL SIMPAN PERMINTAAN POTONG");	
		...
		echo "</script>";
        echo "<meta http-equiv='refresh' content='0; url=TutupInOutHarian11Manual'>";
 }
}
?>